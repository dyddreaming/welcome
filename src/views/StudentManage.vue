<template>
  <div class="app-main" style="position: relative">
    ...
    <div
      ...
      "
    >
      <el-button type="primary" class="tableButton" @click="codeReset"
        >批量重置</el-button
      >
      <el-button type="primary" class="tableButton" @click="studentDelete"
        >批量删除</el-button
      >
...
export default {
  ...
  methods: {
    ...
    getData() {
      // 构造查询字符串
      const queryString = `?page=1&pageSize=6&college=${encodeURIComponent(
        this.collegeValue
